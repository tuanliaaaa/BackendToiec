...
public class ResponseBuilder {
    ...
    public static <T> ResponseEntity<ResponseDto<T>> internalErrorResponse(String message, StatusCodeEnum statusCode) {
        final ResponseDto<T> dto = ResponseDto.<T>builder()
                .success(false)
                .message(message)
                .statusCode(statusCode.toString())
    ...
    @Nonnull
    public static <T> ResponseEntity<ResponseDto<T>> accessDeniedResponse(@Nonnull T body, StatusCodeEnum statusCode) {
        final ResponseDto<T> dto = ResponseDto.<T>builder()
                .success(false)
                .data(body)
                .statusCode(statusCode.toString())
    ...
    public static <T> ResponseEntity<ResponseDto<T>> accessDeniedResponse(String message, StatusCodeEnum statusCode) {
        final ResponseDto<T> dto = ResponseDto.<T>builder()
                .success(false)
                .message(message)
                .statusCode(statusCode.toString())
